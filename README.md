...
- [ ] поддержка проксирования запросов на изображения
...
- [ ] поддержка предварительной загрузки изображений (через auth токен)
...
- [ ] поддержка адаптивного ресайза (сохранение соотношения сторон при передаче одного из размеров)
